...
if __name__ == "__main__":
    ...
    print(
        f"Part 1:\nThe lowest house number that receives at least {n_presents_target} present is {solve(n_presents_target, compute_number_of_presents_part1)}.\n"
    )
    print(
        f"Part 2:\nThe lowest house number that receives at least {n_presents_target} present is {solve(n_presents_target, compute_number_of_presents_part2)}.\n"
    )
